...
const { sightings, categories } = db;

// initializing Controllers -> note the lowercase for the first word
const sightingsController = new SightingsController(sightings, db);
const categoriesController = new CategoriesController(categories, db);
